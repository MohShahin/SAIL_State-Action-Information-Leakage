...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addPassthroughCopy("results/experiment7_respiratory_sofa_summary.json");
  eleventyConfig.addPassthroughCopy("results/experiment8_variant_f_summary.json");
